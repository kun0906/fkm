...
from federated_kmeans_kmeans_pp.clustering.greedy_initialization import greedily_initialize
        ...
        for client_data in clients_in_round:
            if self.use_client_init_centroids:  # added by kun
                ...
                if self.init_centroids == 'kmeans++':
                    ...
                    client_centroids = randomly_init_centroid(0, self.n_clusters + 1, self.n_dims, self.n_clusters,
                                                              self.random_state)
