"""
    ...
    # PYTHONPATH='..' PYTHONUNBUFFERED=TRUE python3 Stanford_random_initialization.py -n '00' > a.txt &
    PYTHONPATH='..' PYTHONUNBUFFERED=TRUE python3 Stanford_random_initialization.py --dataset 'FEMNIST' \
